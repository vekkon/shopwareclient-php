...
# **createProduct**
> \Swagger\Client\Model\InlineResponse200201 createProduct($body, $_response)
...
[**\Swagger\Client\Model\InlineResponse200201**](../Model/InlineResponse200201.md)
...
# **getProduct**
> \Swagger\Client\Model\InlineResponse200201 getProduct($id)
...
# **getProductList**
> \Swagger\Client\Model\InlineResponse200199 getProductList($limit, $page, $query)
...
[**\Swagger\Client\Model\InlineResponse200199**](../Model/InlineResponse200199.md)
...
# **updateProduct**
> \Swagger\Client\Model\InlineResponse200201 updateProduct($id, $body, $_response)
...
$id = "id_example"; // string | Identifier for the product
$body = new \Swagger\Client\Model\ProductIdBody(); // \Swagger\Client\Model\ProductIdBody | Partially update information about a Product resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Identifier for the product |
 **body** | [**\Swagger\Client\Model\ProductIdBody**](../Model/ProductIdBody.md)| Partially update information about a Product resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
