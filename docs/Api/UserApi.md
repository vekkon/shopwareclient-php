...
# **createUser**
> \Swagger\Client\Model\InlineResponse200354 createUser($body, $_response)
...
# **getUser**
> \Swagger\Client\Model\InlineResponse200354 getUser($id)
...
# **getUserList**
> \Swagger\Client\Model\InlineResponse200352 getUserList($limit, $page, $query)
...
[**\Swagger\Client\Model\InlineResponse200352**](../Model/InlineResponse200352.md)
...
# **updateUser**
> \Swagger\Client\Model\InlineResponse200354 updateUser($id, $body, $_response)
...
$id = "id_example"; // string | Identifier for the user
$body = new \Swagger\Client\Model\UserIdBody(); // \Swagger\Client\Model\UserIdBody | Partially update information about a User resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Identifier for the user |
 **body** | [**\Swagger\Client\Model\UserIdBody**](../Model/UserIdBody.md)| Partially update information about a User resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
