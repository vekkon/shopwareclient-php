...
# **createCategory**
> \Swagger\Client\Model\InlineResponse20027 createCategory($body, $_response)
...
# **getCategory**
> \Swagger\Client\Model\InlineResponse20027 getCategory($id)
...
# **getCategoryList**
> \Swagger\Client\Model\InlineResponse20025 getCategoryList($limit, $page, $query)
...
# **updateCategory**
> \Swagger\Client\Model\InlineResponse20027 updateCategory($id, $body, $_response)
...
$id = "id_example"; // string | Identifier for the category
$body = new \Swagger\Client\Model\CategoryIdBody(); // \Swagger\Client\Model\CategoryIdBody | Partially update information about a Category resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Identifier for the category |
 **body** | [**\Swagger\Client\Model\CategoryIdBody**](../Model/CategoryIdBody.md)| Partially update information about a Category resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
