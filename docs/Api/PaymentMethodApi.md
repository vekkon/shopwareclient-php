...
# **createPaymentMethod**
> \Swagger\Client\Model\InlineResponse200195 createPaymentMethod($body, $_response)
...
# **getPaymentMethod**
> \Swagger\Client\Model\InlineResponse200195 getPaymentMethod($id)
...
> \Swagger\Client\Model\InlineResponse200193 getPaymentMethodList($limit, $page, $query)
...
# **updatePaymentMethod**
> \Swagger\Client\Model\InlineResponse200195 updatePaymentMethod($id, $body, $_response)
