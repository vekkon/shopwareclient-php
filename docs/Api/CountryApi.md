...
# **createCountry**
> \Swagger\Client\Model\InlineResponse20042 createCountry($body, $_response)
...
# **getCountry**
> \Swagger\Client\Model\InlineResponse20042 getCountry($id)
...
# **getCountryList**
> \Swagger\Client\Model\InlineResponse20040 getCountryList($limit, $page, $query)
...
# **updateCountry**
> \Swagger\Client\Model\InlineResponse20042 updateCountry($id, $body, $_response)
